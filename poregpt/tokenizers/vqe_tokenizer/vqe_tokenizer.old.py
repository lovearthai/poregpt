...
def load_accelerate_checkpoint(model_ckpt_dir: str):
    ...
    return {'model_state_dict': state_dict, 'cnn_type': cnn_type,'model_type':model_type,"codebook_size":codebook_size,"codebook_fsqd":codebook_fsqd,"codebook_fsqn":codebook_fsqn}
