...
def main():
    ...
    vqe_train(
        ...
        codebook_diversity_loss_weight=config.get("codebook_diversity_loss_weight", 1.0),
        orthogonal_reg_weight=config.get("orthogonal_reg_weight", 1.0),
        ...
        cnn_type=config.get("cnn_type", 0),
