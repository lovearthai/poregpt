...
# Define base paths
BASE_INPUT_DIR="/mnt/nas_syy/default/poregpt/dataset/${DATASET_NAME}/memap_${DATA_STRATEGY}/jsonlgz_${VQE_VERSION}"
BASE_OUTPUT_DIR="/mnt/nas_syy/default/poregpt/dataset/${DATASET_NAME}/memap_${DATA_STRATEGY}/jsonlgz_${VQE_VERSION}_split${CHUNK_WINDOW_SIZE}_overlap${CHUNK_OVERLAP_SIZE}"
