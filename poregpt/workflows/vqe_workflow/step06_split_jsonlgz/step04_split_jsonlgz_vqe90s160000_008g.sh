...
VQE_VERSION="vqe90s160000"
DATASET_NAME="human_dna_008g"
# Define base paths
BASE_INPUT_DIR="/mnt/nas_syy/default/poregpt/dataset/${DATASET_NAME}/memap_lemon5/jsonlgz_${VQE_VERSION}"
BASE_OUTPUT_DIR="/mnt/nas_syy/default/poregpt/dataset/${DATASET_NAME}/memap_lemon5/jsonlgz_${VQE_VERSION}_split1280_overlap1024"
