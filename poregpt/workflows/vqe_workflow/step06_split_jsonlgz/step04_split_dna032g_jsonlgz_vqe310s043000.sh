...
VQE_VERSION="vqe310s043000"
DATASET_NAME="human_dna_032g"
# Define base paths
BASE_INPUT_DIR="/mnt/nas_syy/default/poregpt/dataset/${DATASET_NAME}/memap_mongoq30/jsonlgz_${VQE_VERSION}"
BASE_OUTPUT_DIR="/mnt/nas_syy/default/poregpt/dataset/${DATASET_NAME}/memap_mongoq30/jsonlgz_${VQE_VERSION}_split1280_overlap1024"
