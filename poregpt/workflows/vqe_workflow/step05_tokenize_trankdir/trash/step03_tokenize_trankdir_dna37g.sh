...
INPUT_DIR="/mnt/nas_syy/default/poregpt/shared/dataset/dna/human_min0_max2_read96655/trank_apple"

# Output directory for .jsonl.gz files
OUTPUT_DIR="/mnt/nas_syy/default/poregpt/shared/dataset/dna/human_min0_max2_read96655/jsonlgz_vqe_model_pass25_c64k_gstep57500"

# Path to your trained VQ tokenizer model checkpoint (.pth file)
MODEL_CHECKPOINT="/mnt/nas_syy/default/poregpt/poregpt/poregpt/workflows/vqe_workflow/step02_train_vqe_model/pass25_w64_c64k_cnn3/models_scratch_cnn3/porepgt_vqe_tokenizer.step57500.pth"
