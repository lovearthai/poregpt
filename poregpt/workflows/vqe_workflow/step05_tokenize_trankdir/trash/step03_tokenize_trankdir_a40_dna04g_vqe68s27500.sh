...
INPUT_DIR="/mnt/nas_syy/default/poregpt/dataset/human_min0_max2_read96655_p10/memap_lemon5"

# Output directory for .jsonl.gz files
OUTPUT_DIR="/mnt/nas_syy/default/poregpt/dataset/human_min0_max2_read96655_p10/memap_lemon5/jsonlgz_vqe68s27500"


# Path to your trained VQ tokenizer model checkpoint (.pth file)
MODEL_CHECKPOINT="/mnt/nas_syy/default/poregpt/models/vqe_models/pass50_dna37g_scratch_c64k_cnn8-lr5e4_dbsz48_gbsz8192-lc2400/models/porepgt_vqe_tokenizer.step67000.pth"
MODEL_CHECKPOINT="/mnt/nas_syy/default/poregpt/models/vqe_models/pass68_dna04g_scratch_c64k_cnn7-lr1e4_dbsz64_gbsz2048-lc2400-lemon5-cw9/models/porepgt_vqe_tokenizer.step27500.pth"
