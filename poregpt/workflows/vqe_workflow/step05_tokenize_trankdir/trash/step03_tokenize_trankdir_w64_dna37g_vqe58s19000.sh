...
INPUT_DIR="/mnt/si003067jezr/default/poregpt/shared/dataset/dna/human_min0_max2_read96655/trank_apple"

# Output directory for .jsonl.gz files
OUTPUT_DIR="/mnt/si003067jezr/default/poregpt/shared/dataset/dna/human_min0_max2_read96655/jsonlgz_vqe58s19000"


# Path to your trained VQ tokenizer model checkpoint (.pth file)
MODEL_CHECKPOINT="/mnt/si003067jezr/default/poregpt/models/vqe_models/pass50_dna37g_scratch_c64k_cnn8-lr5e4_dbsz48_gbsz8192-lc2400/models/porepgt_vqe_tokenizer.step19000.pth"
MODEL_CHECKPOINT="/mnt/si003067jezr/default/poregpt/models/vqe_models/pass58_dna37g_scratch_c64k_cnn8-lr2e4_dbsz48_gbsz8192-lc2400-cw9/models/porepgt_vqe_tokenizer.step19000.pth"
