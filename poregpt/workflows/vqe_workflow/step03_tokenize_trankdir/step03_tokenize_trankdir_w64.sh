...
INPUT_DIR="/mnt/si003067jezr/default/poregpt/shared/dataset/dna/dna814g/trank"

# Output directory for .jsonl.gz files
OUTPUT_DIR="/mnt/si003067jezr/default/poregpt/shared/dataset/dna/dna814g/jsonlgz"

# Path to your trained VQ tokenizer model checkpoint (.pth file)
MODEL_CHECKPOINT="/mnt/si003067jezr/default/poregpt/poregpt/poregpt/workflows/vqe_workflow/step02_train_vqe_model/pass25_w64_c64k_cnn3/models_scratch_cnn3/porepgt_vqe_tokenizer.step22500.pth"
