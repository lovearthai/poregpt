...
INPUT_SHARDS_DIR="/mnt/nas_syy/default/poregpt/dataset/human_dna_032g/memap_mongoq30/trank/train"

# 输出目录：存放分片的 64-dim 特征 memmap 文件 + shards.json
OUTPUT_SHARD_DIR="/mnt/nas_syy/default/poregpt/dataset/human_dna_032g/memap_mongoq30/trank/train/cnn12_features"

# CNN 模型检查点路径（必须是包含 'model_state_dict' 的 .pth 文件）
CHECKPOINT_PATH="/mnt/nas_syy/default/poregpt/poregpt/poregpt/workflows/vqe_workflow/step01_train_cnn_model/human_dna_595g_memap_mongoq30/cnn12/models/nanopore_cnn12_lr1e5.epoch100.pth"
